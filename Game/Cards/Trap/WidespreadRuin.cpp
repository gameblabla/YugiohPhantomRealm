...
namespace Card{
		...
		void WidespreadRuin::setupBigCards(){
		...
		void WidespreadRuin::cleanup(){
			
		}
		void WidespreadRuin::update(){
			if(hasCards){
		...
		void WidespreadRuin::startUpdate(){
		...
		void WidespreadRuin::fadeInUpdate(){
		...
		void WidespreadRuin::burnUpdate(){
		...
		void WidespreadRuin::fadeCardUpdate(){
		...
		void WidespreadRuin::fadeOutUpdate(){
			particleUnit.swapFlames();
		...
		void WidespreadRuin::returnUpdate(){
			theBoard.LP.reveal();
		...
		void WidespreadRuin::endUpdate(){

		}


		bool WidespreadRuin::listen(int info){
