...
namespace Card{
		...
		void AcidHole::cleanup(){
			
		}
		void AcidHole::update(){
			if(hasCards){
		...
		void AcidHole::endUpdate(){

		}


		bool AcidHole::listen(int info){
